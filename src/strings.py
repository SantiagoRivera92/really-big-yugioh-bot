...
COMMAND_NAME_TOURNAMENT_JOIN = "t_join" # Deprecated
COMMAND_NAME_TOURNAMENT_JOIN = "t_join" # In development
...
COMMAND_NAME_TOURNAMENT_DQ_UNREGISTERED = "t_cleanup" # Done
COMMAND_NAME_TOURNAMENT_CLEANUP_CHALLONGE = "t_challonge_cleanup" # Done
COMMAND_UPDATE_CHALLONGE_IDS = "update_challonge_ids" #Done
